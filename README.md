# Signals Generator & Operator (MATLAB)

A modular and fully functional MATLAB-based Signals Generator and Operator developed as part of the Signals and Systems course (Mechatronics & Robotics Engineering Program). The project provides a flexible environment for generating, manipulating, and analyzing different signal types through an interactive workflow.
...
Part I contains handwritten analytical solutions and is included in the full project documentation.
